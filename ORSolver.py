...
if __name__ == "__main__":
    ...
    visualizer.save_plot(image_filename_graphical)

    image_filename_simplex = f'{calculation_folder}/graphique_solution_simplex.png'
    simplex_solver.plot_solution(image_filename_simplex)
